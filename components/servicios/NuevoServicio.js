...
const NuevoServicio = ({ cliente, detalle, importe, fecha, handleBlur, handleChange, handleSubmit, errores }) => {

    if (!cliente) return <div>CARGANBDO..</div>

    return (
        <div className="container mt-4 border border-dark alert alert-primary">
            <h1 className="mt-4 mb-4"><strong><u>Cargar Servicio</u></strong></h1>
            <form className="border border-dark p-4" onSubmit={handleSubmit}>
                <h2 className=" mb-4 "><strong><u>Cliente</u></strong></h2>
                ...
                <h2 className="mt-4 mb-4 "><strong><u>Servicio</u></strong></h2>
                ...
                <div className="row border border-dark p-4">
                    ...
                    <div className="form-group col-md-4">
                        <button type="submit" className="btn btn-primary btm-block mt-4">Registrar Servicio</button>
